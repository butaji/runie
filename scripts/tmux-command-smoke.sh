...
labels=(
  ...
  "Memory" "Remember" "Goal" "Workflow" "Workflows" "Sessions" "Session History" "Undo Session" "Questions" "Active Jobs" "Cancel All Jobs" "Clear Finished Jobs" "Git Status" "Git Diff" "Git Conflicts" "Ready MCP Servers" "Failed MCP Servers" "Loop" "Deep Research" "Feedback" "Usage"
...
parameterized=(
  ...
  "Goal" "Workflow" "Loop" "Deep Research" "Feedback" "Usage" "Background Jobs" "Questions" "Jobs" "Git Status" "Git Diff" "Git Conflicts" "Job Output"
)
