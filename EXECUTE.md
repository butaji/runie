...
Deliverables. Working cargo-rune CLI with dev, build, check, and transpile subcommands. 12 framework examples (examples/01_axum_api/ through examples/12_candle_infer/) demonstrating zero-overhead TS→Rust mappings for Axum, Actix-web, Ratatui, Tauri, Dioxus, egui, Leptos, Yew, Bevy, SQLx, Tonic, and Candle. All generated code stays in target/. No .generated/ folders in source trees.