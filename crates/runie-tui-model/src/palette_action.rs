runie_core::typed_action_registry! {
    pub enum PaletteAction {
        ...
        AlwaysApprove => "Always Approve", AutoApprove => "Automatic Approval", AskBeforeTools => "Ask Before Tools", ApprovalHistory => "Approval History", ClearApprovalHistory => "Clear Approval History", Deny => "Deny Tools", PlanMode => "Plan Mode",
        ...
        FailedJobs => "Failed Jobs", RunningJobs => "Running Jobs", CancelledJobs => "Cancelled Jobs", CancelledSchedulerJobs => "Cancelled Scheduler Jobs", CancelQueuedJobs => "Cancel Queued Jobs", JobOutput => "Job Output", JobOutputFacts => "Job Output Facts", JobOutputPreview => "Job Output Preview", JobOutputSearch => "Job Output Search", JobOutputHead => "Job Output Head", JobOutputTail => "Job Output Tail",
        GitStatus => "Git Status", GitDiff => "Git Diff", GitReview => "Git Review", GitCommitPrepare => "Prepare Git Commit", GitCommit => "Commit Git", GitPush => "Push Git", GitRevert => "Revert Git", GitWorktrees => "Git Worktrees",
