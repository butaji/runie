runie_core::typed_action_registry! {
    pub enum PaletteAction {
        ...
        FailedJobs => "Failed Jobs", RunningJobs => "Running Jobs", CancelledJobs => "Cancelled Jobs", CancelQueuedJobs => "Cancel Queued Jobs", JobOutput => "Job Output", JobOutputFacts => "Job Output Facts", JobOutputPreview => "Job Output Preview", JobOutputSearch => "Job Output Search", JobOutputHead => "Job Output Head", JobOutputTail => "Job Output Tail",
