runie_core::typed_action_registry! {
    pub enum PaletteAction {
        ...
        Help => "Help", ContextInfo => "Context Info", ContextPolicy => "Context Policy", ContextPolicyOn => "Enable Context Policy", ContextPolicyOff => "Disable Context Policy", Settings => "Settings", Doctor => "Doctor",
        ...
        FailedJobs => "Failed Jobs", CancelledJobs => "Cancelled Jobs", CancelQueuedJobs => "Cancel Queued Jobs", JobOutput => "Job Output", JobOutputFacts => "Job Output Facts",
