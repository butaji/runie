...
pub use feed::{
    activity_text, atx_heading, classify_activity_tool, completed_tool_header_with_args,
    ...
    ToolCardKind, ToolCardPaintIntent, ToolCardRow, ToolCardRowKind, DEFAULT_THINKING_ELAPSED_MS,
