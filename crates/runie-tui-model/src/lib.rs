...
pub use feed::{
    ...
    find_all_containing, find_first_containing, format_clock_timestamp, format_elapsed,
    ...
    last_assistant_text, line_is_blank, logical_tool_member_index, logical_tool_member_index_at,
    make_relative_path, model_selector_rows, project_tool_blocks, project_tool_card_rows,
    repository_label, running_bullet, selected_cell_text, session_start_messages,
