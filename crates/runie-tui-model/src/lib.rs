...
pub use feed::{
    ...
    append_wrapped, append_wrapped_words, atx_heading, classify_activity_tool,
    completed_tool_header_with_args, current_tool_args, current_tool_header,
    default_tool_display_mode, dense_tool_group_members, format_clock_timestamp, format_elapsed,
    format_error, grok_effective_compact, grok_small_screen_tip_visible, is_fence, is_output_tool,
    is_quit_command, is_table_row, is_table_separator, is_transport_only_update,
    logical_tool_member_index, make_relative_path, model_selector_rows, project_tool_blocks,
    project_tool_card_rows, repository_label, running_bullet, session_start_messages,
    structured_update_messages, structured_update_text, table_bottom_border, thinking_summary,
    ...
    welcome_modal_lines, workflow_text, ActivityKind, CellPosition, CellSelection, FeedNavigation,
    FeedSnapshot, FeedState, Line, LineKind, ScrollbackMsg, ToolBlock, ToolCardKind,
    ToolCardPaintIntent, ToolCardRow, ToolCardRowKind, VersionBadgeVariant,
