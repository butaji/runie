...
pub async fn generate_summary(
    ...
    let llm_messages = vec![
        tidy_core::Message::System { content: "You are a summarization assistant. Condense the conversation while preserving all important facts, decisions, and context.".to_string() },
        tidy_core::Message::User { content: prompt, attachments: vec![] },
    ];
