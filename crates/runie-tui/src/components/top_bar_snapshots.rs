...
fn make_test_colors() -> ThemeColors {
    ThemeColors {
        bg_base: Color::Black, bg_panel: Color::Black,
        accent_primary: Color::White, accent_secondary: Color::Blue,
        text_primary: Color::White, text_secondary: Color::White,
        text_dim: Color::Gray, text_muted: Color::DarkGray,
        border_unfocused: Color::DarkGray, success: Color::Green,
        error: Color::Red, warning: Color::Yellow,
        syntax_phase: Color::Yellow, text_plan: Color::Cyan,
        feed_tool_bar: Color::Magenta, accent_user: Color::Green,
        accent_assistant: Color::Blue, accent_thinking: Color::Yellow,
        accent_tool: Color::Cyan, accent_system: Color::DarkGray,
        accent_error: Color::Red, accent_success: Color::Green,
        accent_running: Color::Yellow, accent_skill: Color::Magenta,
        accent_plan: Color::Cyan, accent_feedback: Color::Red,
        accent_model: Color::Blue, accent_teal: Color::Cyan,
        accent_orange: Color::Red, accent_purple: Color::Magenta,
        accent_yellow: Color::Yellow, accent_blue_bright: Color::Blue,
        command: Color::Green, path: Color::Blue,
        running: Color::Yellow, fuzzy_accent: Color::Green,
        editor_bg: Color::Black, surface_bg: Color::Black,
