...
impl App {
    ...
    pub fn new_with_broker_and_approval(
        ...
        Self {
            ...
            question_broker,
            approval_mode,
            approval_traces: Default::default(),
            ...
            tool_executor: None,
            tool_hooks: None,
            tool_command_tasks: super::ToolCommandTaskActor::new(),
            plugin_host: None,
            submission_tx,
    ...
    pub fn attach_tool_hooks(&mut self, hooks: runie_core::tools::executor::ToolExecHooks) {
    ...
    pub fn attach_background_actor(
        &mut self,
    ...
    pub fn attach_plugin_host(&mut self, host: runie_core::plugins::PluginHost) {
