...
impl EventLabel for Event {
    fn default_label(&self) -> String {
        match self {
            runie_core::Event::Quit => "Quit".into(),
            runie_core::Event::Submit => "Submit".into(),
            runie_core::Event::RunSaveCommand { .. } => "Save".into(),
            runie_core::Event::RunLoadCommand { .. } => "Load".into(),
            runie_core::Event::RunDeleteCommand { .. } => "Delete".into(),
            runie_core::Event::RunExportCommand { .. } => "Export".into(),
            runie_core::Event::RunImportCommand { .. } => "Import".into(),
            runie_core::Event::RunLoginCommand { .. } => "Login".into(),
            runie_core::Event::RunLogoutCommand { .. } => "Logout".into(),
            runie_core::Event::RunSkillCommand { .. } => "Run Skill".into(),
            _ => "Action".into(),
        }
    }
}
