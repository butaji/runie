...
pub fn handle_palette(state: &mut AppState, palette: &mut CommandPalette, msg: &crate::tui::state::Msg) -> Vec<crate::UiCmd> {
...
fn handle_palette_filter(state: &mut AppState, palette: &mut CommandPalette, c: char) -> Vec<crate::UiCmd> {
...
fn handle_palette_backspace(state: &mut AppState, palette: &mut CommandPalette) -> Vec<crate::UiCmd> {
...
fn handle_palette_up(state: &mut AppState, palette: &mut CommandPalette) -> Vec<crate::UiCmd> {
    palette.selected = palette.selected.saturating_sub(1);
    state.command_palette.selected = palette.selected;
    vec![]
}

fn handle_palette_down(state: &mut AppState, palette: &mut CommandPalette) -> Vec<crate::UiCmd> {
