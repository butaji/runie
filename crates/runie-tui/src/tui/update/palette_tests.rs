...
mod command_execution_tests {
    ...
    fn test_new_session_clears_all_messages() {
        ...
        state.messages.push(MessageItem::Assistant { text: "assistant msg".to_string(), model: None, timestamp: None, expanded: false, thought_duration: None, turn_duration: None });
