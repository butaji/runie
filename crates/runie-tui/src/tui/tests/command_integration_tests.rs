...
fn test_slash_clear_command_clears_messages() {
    ...
    state.messages.push(MessageItem::Assistant { text: "Hi there".to_string(), model: None, timestamp: None, expanded: false, thought_duration: None, turn_duration: None });
...
fn test_slash_clear_and_palette_clear_produce_same_result() {
    ...
    state1.messages.push(MessageItem::Assistant { text: "Hi there".to_string(), model: None, timestamp: None, expanded: false, thought_duration: None, turn_duration: None });
    ...
    state2.messages.push(MessageItem::Assistant { text: "Hi there".to_string(), model: None, timestamp: None, expanded: false, thought_duration: None, turn_duration: None });
