...
fn test_clear_chat_resets_messages() {
    ...
    state.messages.push(MessageItem::Assistant { text: "hi".to_string(), model: Some("gpt-4".to_string()), timestamp: None, expanded: false, thought_duration: None, turn_duration: None });
