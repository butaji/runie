...
mod stream;
pub use stream::{
    parse_mcp_event_stream, reduce_mcp_stream_event, McpConnectionStatus, McpReconnectDecision,
    McpReconnectPolicy, McpReconnectState, McpStreamEvent, McpStreamSnapshot,
};
