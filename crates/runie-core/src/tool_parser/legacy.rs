//! Legacy tool-call parsing (TOOL:tool_name:args format).

use serde_json::{Map, Value};

use super::{ParsedToolCall, ToolParseError};

/// Parse a legacy tool call from a payload string.
///
/// Supports both colon-separated (TOOL:bash:ls) and whitespace-separated
...
fn build_legacy_args(tool_name: &str, arg1: String, arg2: String) -> Option<Value> {
...
pub fn parse_legacy_tools_in_line(line: &str) -> Vec<Result<ParsedToolCall, ToolParseError>> {
    ...
    // Check for inline legacy markers
