...
mod tests {
    ...
    fn delete_word_at_middle_of_word() {
        ...
        state.update(Event::Input(InputEvent::CursorEnd)); // at 11
        state.update(Event::Input(InputEvent::CursorLeft)); // at 10
        state.update(Event::Input(InputEvent::CursorLeft)); // at 9
        state.update(Event::Input(InputEvent::CursorLeft)); // at 8 (before 'r')
    ...
    fn delete_to_start_removes_from_start_to_cursor() {
        ...
        state.update(Event::Input(InputEvent::CursorLeft));
        state.update(Event::Input(InputEvent::CursorLeft));
        state.update(Event::Input(InputEvent::DeleteToStart));
