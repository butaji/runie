...
mod tests {
    ...
    fn paste_strips_newlines() {
        ...
        assert_eq!(state.input, "line1line2", "Newlines should be stripped from paste");
    }
    ...
    fn paste_strips_carriage_returns() {
        ...
        assert_eq!(state.input, "ab", "CRLF should be stripped");
    }
    ...
    fn paste_replaces_tabs_with_spaces() {
        ...
        assert_eq!(state.input, "a    b", "Tabs should be replaced with 4 spaces");
    }
