...
pub enum Part {
    ...
    AnthropicThinking { content: String, signature: Option<String> },
    /// A tool invocation requested by the assistant.
    ToolCall { id: String, name: String, args: Value },
    /// The result returned for a tool invocation.
    ToolResult { id: String, output: String },
    /// Tool call requiring user confirmation
    ToolConfirmation { id: String, name: String, args: Value, description: Option<String> },
...
impl Part {
    ...
    pub fn reasoning_encrypted(data: impl Into<String>, signature: Option<String>) -> Self {
        Self::ReasoningEncrypted { data: data.into(), signature }
    }

    pub fn anthropic_thinking(content: impl Into<String>, signature: Option<String>) -> Self {
        Self::AnthropicThinking { content: content.into(), signature }
    }
    ...
    pub fn tool_result(id: impl Into<String>, output: impl Into<String>) -> Self {
        Self::ToolResult { id: id.into(), output: output.into() }
    }
    ...
    pub fn tool_confirmation(
        ...
        Self::ToolConfirmation { id: id.into(), name: name.into(), args, description }
    }
