...
live TUI smoke matrix. The latest live run exercised 123 TUI cases with
`passed=123 failed=0`; all workspace test binaries passed. Formatting, clippy,
structural lint, and
...
actor-owned implementation, focused tests, `just ci`, 123-case live TUI smoke,
