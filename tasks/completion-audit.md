...
live TUI smoke matrix. The latest live run exercised 97 TUI cases with
`passed=97 failed=0`; the workspace test run passed all workspace test
...
actor-owned implementation, focused tests, `just ci`, 97-case live TUI smoke,
