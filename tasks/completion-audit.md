...
live TUI smoke matrix. The latest live run exercised 109 TUI cases with
`passed=109 failed=0`; all workspace test binaries passed. Formatting, clippy,
structural lint, and
...
actor-owned implementation, focused tests, `just ci`, 109-case live TUI smoke,
