...
live TUI smoke matrix. The latest live run exercised 118 TUI cases with
`passed=118 failed=0`; all workspace test binaries passed. Formatting, clippy,
structural lint, and
...
actor-owned implementation, focused tests, `just ci`, 118-case live TUI smoke,
