...
live TUI smoke matrix. The latest live run exercised 107 TUI cases with
`passed=107 failed=0`; all workspace test binaries passed. Formatting, clippy,
structural lint, and
...
actor-owned implementation, focused tests, `just ci`, 107-case live TUI smoke,
