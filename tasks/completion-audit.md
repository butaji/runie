...
live TUI smoke matrix. The latest live run exercised 121 TUI cases with
`passed=121 failed=0`; all workspace test binaries passed. Formatting, clippy,
structural lint, and
...
actor-owned implementation, focused tests, `just ci`, 121-case live TUI smoke,
