...
live TUI smoke matrix. The latest live run exercised 96 TUI cases with
`passed=96 failed=0`; the workspace test run passed all workspace test
...
actor-owned implementation, focused tests, `just ci`, 96-case live TUI smoke,
