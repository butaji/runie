...
live TUI smoke matrix. The latest live run exercised 86 TUI cases with
`passed=86 failed=0`; the workspace test run passed 552 core tests and all
...
actor-owned implementation, focused tests, `just ci`, 86-case live TUI smoke,
