...
live TUI smoke matrix. The latest live run exercised 122 TUI cases with
`passed=122 failed=0`; all workspace test binaries passed. Formatting, clippy,
structural lint, and
...
actor-owned implementation, focused tests, `just ci`, 122-case live TUI smoke,
