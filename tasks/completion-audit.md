...
live TUI smoke matrix. The latest live run exercised 98 TUI cases with
`passed=98 failed=0`; the workspace test run passed all workspace test
...
actor-owned implementation, focused tests, `just ci`, 98-case live TUI smoke,
