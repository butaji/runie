...
live TUI smoke matrix. The latest live run exercised 95 TUI cases with
`passed=95 failed=0`; the workspace test run passed all workspace test
...
actor-owned implementation, focused tests, `just ci`, 95-case live TUI smoke,
