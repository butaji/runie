...
live TUI smoke matrix. The latest live run exercised 110 TUI cases with
`passed=110 failed=0`; all workspace test binaries passed. Formatting, clippy,
structural lint, and
...
actor-owned implementation, focused tests, `just ci`, 110-case live TUI smoke,
