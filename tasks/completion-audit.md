...
live TUI smoke matrix. The latest live run exercised 120 TUI cases with
`passed=120 failed=0`; all workspace test binaries passed. Formatting, clippy,
structural lint, and
...
actor-owned implementation, focused tests, `just ci`, 120-case live TUI smoke,
