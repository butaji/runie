...
live TUI smoke matrix. The latest live run exercised 111 TUI cases with
`passed=111 failed=0`; all workspace test binaries passed. Formatting, clippy,
structural lint, and
...
actor-owned implementation, focused tests, `just ci`, 111-case live TUI smoke,
