...
**Blocks**: test-actor-harness, env-actor-owns-git-cwd, fff-indexer-owns-file-picker-results, remove-direct-appstate-mutations, migrate-production-actors-to-ractor, expand-leader-start-for-tui-and-cli
