...
- [ ] **Actor/SSOT:** N/A (UI comparison; actors remain authoritative).
- [ ] **Trigger events:** N/A (UI comparison doesn't introduce new state transitions).
- [ ] **Observer events:** N/A (UI comparison doesn't emit events).
- [ ] **No direct mutations:** N/A (UI comparison doesn't change state ownership).
- [ ] **No new mirrors:** N/A (UI comparison doesn't introduce new state).
- [ ] **Async work observed:** N/A (UI comparison doesn't introduce new async work).
