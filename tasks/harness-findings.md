...
10. `harness-10-mcp` — **partial** — typed server/tool data, atomic qualified registry registration, owner-supplied call hook, and bounded stdio JSON-RPC discovery/call now exist; HTTP transport, auth, and host-level cleanup remain.
