...
12. `harness-12-git` — **partial** — bounded read-only `git_status`, `git_diff`, and machine-readable `git_review` are registered and tested; worktrees and safe commit preparation remain.
