...
12. `harness-12-git` — **partial** — bounded read-only `git_status` and `git_diff` tools are registered and tested; patch review, worktrees, and safe commit preparation remain.
