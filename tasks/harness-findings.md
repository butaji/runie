...
13. `harness-13-sessions` — **partial** — resume/fork/rename/export foundations exist, and pure deterministic session search ranking now covers IDs, names, and previews; actor-backed index and full undo/search UX remain.
