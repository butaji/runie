...
2. `harness-02-permissions` — **partial** — pure Ask/Auto/YOLO policy now routes live mutating tools through the existing owned question dialog; persistent always/deny modes and replay fixtures remain.
