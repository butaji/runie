...
10. `harness-10-mcp` — **partial** — typed server/tool data, atomic qualified registry registration, owner-supplied call hook, and bounded owned stdio JSON-RPC exchange now exist; discovery, HTTP transport, auth, and host-level cleanup remain.
