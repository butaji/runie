...
9. `harness-09-web` — typed bounded `web_search` contract, executor hook, and HTTP client with structured citation results now exist; provider adapters and source cards remain.
