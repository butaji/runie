...
10. `harness-10-mcp` — **partial** — typed server/tool data, atomic stdio discovery/call registration, and owned qualified tool hooks now exist; HTTP transport, auth, and host-level cleanup remain.
