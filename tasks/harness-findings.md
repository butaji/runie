...
13. `harness-13-sessions` — **partial** — resume/fork/rename/export foundations exist, and an actor-owned session search index now reduces upsert/remove/search events through deterministic ranking; full undo and storage discovery UX remain.
