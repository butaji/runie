...
Typed live-event admission (2026-08-09): the session event bridge now decodes
known operation-lane families into `SessionConfigRecord::TypedOperation` before
mailbox delivery. Unknown or legacy record names retain the generic
