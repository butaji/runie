...
> **Current gap:** `runie-core` has grown into a large catch-all crate (~60k production lines, ~40 public modules). The `Event` enum taxonomy methods are now generated from `taxonomy.json`.
