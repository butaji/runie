...
- **8 `blocked` tasks** — Grok Build comparison tasks blocked on Grok Build availability; see `tasks/index.json`.
- **0 `partial` tasks** — plan mode and compaction tasks completed; deferred items documented in task files.
- **18 `wontfix` tasks** — see `tasks/index.json` for the current list.
