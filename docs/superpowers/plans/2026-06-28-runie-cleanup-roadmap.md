...
## Status: Active bugs from live TUI/CLI testing and architecture review

The original cleanup is complete: **108 `done`**, **3 `wontfix`**. Live mock-provider TUI/CLI testing on 2026-06-30 plus a focused architecture review revealed regressions and wiring gaps that must be fixed before real MiniMax testing:

- **38 `todo` tasks** — see `tasks/index.json` for details.
