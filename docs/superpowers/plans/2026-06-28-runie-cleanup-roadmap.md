...
- **259 `todo` tasks** — see `tasks/index.json` for details.
- **5 `blocked` tasks** — Grok Build comparison tasks blocked on fixture/recorder/harness readiness; see `tasks/index.json`.
- **0 `partial` tasks** — tasks with partial implementation; see `tasks/index.json`.
- **5 `wontfix` tasks** — see `tasks/index.json` for the current list.
