...
- **78 `todo` tasks** — see `tasks/index.json` for details.
- **4 `blocked` tasks** — Grok Build comparison tasks blocked on fixture/recorder/harness readiness; see `tasks/index.json`.
